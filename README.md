...
Our project is focused on the translation of Catalan (ca) $\to$ Italian (it). For our baseline system, we employed an Encoder-Decoder architecture with an attention mechanism, similar to $\textit{Attention is all you need}$  (Vaswani et al.,
